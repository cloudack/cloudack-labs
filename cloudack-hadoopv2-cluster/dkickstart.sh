...
sudo su - vagrant -c '/home/vagrant/hadoop-2.2.0-cdh5.0.0-beta-1/sbin/hadoop-daemon.sh start datanode'
sudo su - vagrant -c '/home/vagrant/hadoop-2.2.0-cdh5.0.0-beta-1/sbin/yarn-daemon.sh start nodemanager'
